...
CREATE TABLE IF NOT EXISTS public.steam_user_marketable_game (
	...
	, CONSTRAINT user_game_trade_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
	, CONSTRAINT user_game_trade_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.steam_user(id)
);
...
CREATE TABLE IF NOT EXISTS public.game_badges (
	...
	, CONSTRAINT game_badges_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
);
...
CREATE TABLE IF NOT EXISTS public.user_badges (
	...
	, CONSTRAINT user_badges_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.steam_user(id)
);
...
CREATE TABLE IF NOT EXISTS public.steam_item (
	...
	, CONSTRAINT steam_item_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
...
CREATE TABLE IF NOT EXISTS public.steam_item_description (
	...
	, CONSTRAINT steam_item_description_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.steam_item(id)
);
...
CREATE TABLE IF NOT EXISTS public.steam_trading_card (
	...
	, CONSTRAINT steam_trading_card_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
	, CONSTRAINT steam_trading_card_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.steam_item(id)
);


-- inventory
CREATE TABLE IF NOT EXISTS public.steam_asset (
	  id int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 3753000)
	, game_id int4 NOT NULL
	, item_id int4 NOT NULL
	, user_id int4 NOT NULL
	...
	, CONSTRAINT steam_asset_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
	, CONSTRAINT steam_asset_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.steam_item(id)
	, CONSTRAINT steam_asset_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.steam_user(id)
);


-- sell listing
CREATE TABLE IF NOT EXISTS public.sell_listing (
	  id int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 260000)
	, game_id int4 NOT NULL
	, item_id int4 NOT NULL
	...
	, CONSTRAINT sell_listing_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
	, CONSTRAINT sell_listing_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.steam_item(id)
	, CONSTRAINT sell_listing_asset_id_fkey FOREIGN KEY (asset_id) REFERENCES public.steam_asset(id)
	, CONSTRAINT sell_listing_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.steam_user(id)
);


-- buy order
CREATE TABLE IF NOT EXISTS public.buy_order (
	  id int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 138000)
	, game_id int4 NOT NULL
	, item_id int4 NOT NULL
	, user_id int4 NOT NULL
	...
	, CONSTRAINT buy_order_game_id_fkey FOREIGN KEY (game_id) REFERENCES public.steam_game(id)
	, CONSTRAINT buy_order_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.steam_item(id)
	, CONSTRAINT buy_order_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.steam_user(id)
);
